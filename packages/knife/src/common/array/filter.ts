 ...
 * @param iterator
 */
export function filter<T extends Iterable<any>>(obj: T, iterator: (v: IterableValue<T>, k: number, o: T) => any): IterableValue<T>[]
export function filter<T extends ArrayLike<any>, K extends Exclude<keyof T, 'length'>>(obj: T, iterator: (v: T[K], k: number, o: T) => any): T[K][]
